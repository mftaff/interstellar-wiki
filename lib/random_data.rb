module RandomData
    ...
    def self.random_space_sentence
        strings = []
        rand(3..7).times do
            (rand(0..2) < 2) ? (strings << @@grammer_words.sample) : (strings << @@space_words.sample)
        end
